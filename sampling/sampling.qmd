...
<details>
  ...
  Use the product rule to determine the probability for a particular order:
...
<details>
  ...
  We use the addition rule and the multiplication rule: 
    * The first term is the # of ways to choose 4 of 7 places to write b, then choose 2 places to write g (the other 1 gets filled with r).
