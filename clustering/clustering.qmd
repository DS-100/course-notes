---
title: Clustering (Old Notes from Fall 2024)
format:
  html:
    toc: true
    toc-depth: 5
...
In this example, the horizontal line crosses 4 vertical lines so the optimal K is 4 clusters ([9,41], [5,20], [17,12], and [17,8,7,14]).
