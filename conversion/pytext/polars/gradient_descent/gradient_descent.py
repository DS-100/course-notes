...
# %% [markdown] id="32f98139"
# In the plots below, the colored tangent line shows the local slope of the curve at the current value of $\theta$.  
# A red tangent line means the slope is negative, and a green tangent line means the slope is positive.
#
# To lower the cost, we want to move in the direction that goes downhill.
#
...
# ```
#
# The plots show the key intuition:
#
# - when the slope is **negative**, the curve goes **down as we move right**
# - when the slope is **positive**, the curve goes **down as we move left**
#
# So:
# - negative slope $\rightarrow$ right is downhill
# - positive slope $\rightarrow$ left is downhill
#
...
# ```
#
# In this example, the slope is negative, so increasing $\theta$ moves us downhill.
#
...
# ```
#
# In this example, the slope is positive, so decreasing $\theta$ moves us downhill.
#
# So the derivative tells us the direction of each update:
#
# - negative derivative $\rightarrow$ move right
# - positive derivative $\rightarrow$ move left
#
# #### Algorithm Attempt 1
