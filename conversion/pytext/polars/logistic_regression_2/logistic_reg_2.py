...
# ```
#
# It is important to note that our 0/1 predictions depend on our choice of probability threshold, so the confusion matrix can also change with a new threshold.
#
...
#
# **Recall** (or **sensitivity**, **True Positive Rate**) is defined as 
#
