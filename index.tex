...
\begin{tcolorbox}[enhanced jigsaw, toptitle=1mm, rightrule=.15mm, colback=white, colframe=quarto-callout-note-color-frame, breakable, opacitybacktitle=0.6, arc=.35mm, titlerule=0mm, bottomrule=.15mm, opacityback=0, toprule=.15mm, coltitle=black, bottomtitle=1mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Note}, leftrule=.75mm, left=2mm, colbacktitle=quarto-callout-note-color!10!white]
