...
\begin{tcolorbox}[enhanced jigsaw, toptitle=1mm, opacitybacktitle=0.6, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Note}, colbacktitle=quarto-callout-note-color!10!white, colback=white, colframe=quarto-callout-note-color-frame, leftrule=.75mm, coltitle=black, bottomrule=.15mm, rightrule=.15mm, bottomtitle=1mm, titlerule=0mm, breakable, opacityback=0, left=2mm, toprule=.15mm, arc=.35mm]
