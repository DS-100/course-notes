...
\begin{tcolorbox}[enhanced jigsaw, titlerule=0mm, breakable, colbacktitle=quarto-callout-note-color!10!white, left=2mm, bottomrule=.15mm, toprule=.15mm, colframe=quarto-callout-note-color-frame, opacityback=0, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Note}, leftrule=.75mm, colback=white, bottomtitle=1mm, toptitle=1mm, coltitle=black, arc=.35mm, rightrule=.15mm, opacitybacktitle=0.6]
