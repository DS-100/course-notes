...
\begin{tcolorbox}[enhanced jigsaw, leftrule=.75mm, left=2mm, toptitle=1mm, arc=.35mm, rightrule=.15mm, titlerule=0mm, bottomrule=.15mm, colback=white, breakable, colframe=quarto-callout-note-color-frame, opacityback=0, bottomtitle=1mm, opacitybacktitle=0.6, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Note}, toprule=.15mm, coltitle=black, colbacktitle=quarto-callout-note-color!10!white]
