...
\hypersetup{
  ...
  pdfauthor={Kanu Grover; Bella Crouch; Minh Phan},
  colorlinks=true,
  linkcolor={blue},
  filecolor={Maroon},
  citecolor={Blue},
...
\makeatother
\subtitle{Data 100}
\author{Kanu Grover \and Bella Crouch \and Minh Phan}
\date{}
...
\begin{tcolorbox}[enhanced jigsaw, coltitle=black, arc=.35mm, colframe=quarto-callout-note-color-frame, bottomtitle=1mm, colbacktitle=quarto-callout-note-color!10!white, opacitybacktitle=0.6, colback=white, breakable, rightrule=.15mm, left=2mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Note}, titlerule=0mm, toptitle=1mm, bottomrule=.15mm, leftrule=.75mm, toprule=.15mm, opacityback=0]
