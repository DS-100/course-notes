...
\begin{tcolorbox}[enhanced jigsaw, opacityback=0, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Note}, bottomrule=.15mm, coltitle=black, rightrule=.15mm, breakable, arc=.35mm, toptitle=1mm, colbacktitle=quarto-callout-note-color!10!white, opacitybacktitle=0.6, titlerule=0mm, toprule=.15mm, colback=white, bottomtitle=1mm, leftrule=.75mm, left=2mm, colframe=quarto-callout-note-color-frame]
