...
\begin{document}
\maketitle
\ifdefined\Shaded\renewenvironment{Shaded}{\begin{tcolorbox}[borderline west={3pt}{0pt}{shadecolor}, boxrule=0pt, sharp corners, breakable, frame hidden, interior hidden, enhanced]}{\end{tcolorbox}}\fi
...
\begin{tcolorbox}[enhanced jigsaw, toptitle=1mm, colbacktitle=quarto-callout-note-color!10!white, bottomrule=.15mm, breakable, opacityback=0, leftrule=.75mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Note}, colframe=quarto-callout-note-color-frame, colback=white, bottomtitle=1mm, opacitybacktitle=0.6, titlerule=0mm, arc=.35mm, left=2mm, toprule=.15mm, rightrule=.15mm, coltitle=black]
...
{} &  Year &        Name &  Count \\
\midrule
325621 &  1994 &      Jermey &      7 \\
336075 &  1998 &       Kento &      5 \\
31930  &  1953 &     Johnnie &     20 \\
385744 &  2016 &  Konstantin &      7 \\
88543  &  1982 &        Mary &    837 \\
\bottomrule
\end{tabular}
...
{} &  Year &      Name &  Count \\
\midrule
339362 &  2000 &     Lucio &     31 \\
149124 &  2000 &   Marissa &    601 \\
149272 &  2000 &    Gloria &    196 \\
340457 &  2000 &  Domenico &      7 \\
\bottomrule
\end{tabular}
...
\begin{verbatim}
<pandas.core.groupby.generic.DataFrameGroupBy object at 0x7fee60a26af0>
\end{verbatim}
...
\begin{verbatim}
<seaborn.axisgrid.JointGrid at 0x7fb3dd18de50>
\end{verbatim}
...
\begin{verbatim}
<seaborn.axisgrid.JointGrid at 0x7fb3c824beb0>
\end{verbatim}
