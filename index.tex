...
{\centering \includegraphics{sampling/sampling_files/figure-pdf/cell-8-output-2.pdf}
...
\begin{tcolorbox}[enhanced jigsaw, colback=white, toprule=.15mm, leftrule=.75mm, opacityback=0, breakable, left=2mm, arc=.35mm, colframe=quarto-callout-color-frame, rightrule=.15mm, bottomrule=.15mm]
...
{\centering \includegraphics{gradient_descent/gradient_descent_files/figure-pdf/cell-4-output-2.pdf}
...
gradient as \$\nabla\_\theta f = \frac{\partial f}{\partial \theta_0}
\vec{i} + \frac{\partial f}{\partial \theta_1} \vec{j} \$, where
