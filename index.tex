...
\begin{tcolorbox}[enhanced jigsaw, rightrule=.15mm, coltitle=black, toprule=.15mm, colframe=quarto-callout-note-color-frame, colback=white, arc=.35mm, left=2mm, leftrule=.75mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Note}, opacitybacktitle=0.6, toptitle=1mm, bottomtitle=1mm, titlerule=0mm, bottomrule=.15mm, breakable, opacityback=0, colbacktitle=quarto-callout-note-color!10!white]
