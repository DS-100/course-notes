...
\begin{tcolorbox}[enhanced jigsaw, toprule=.15mm, colback=white, colbacktitle=quarto-callout-note-color!10!white, bottomrule=.15mm, opacityback=0, titlerule=0mm, toptitle=1mm, breakable, arc=.35mm, colframe=quarto-callout-note-color-frame, rightrule=.15mm, leftrule=.75mm, bottomtitle=1mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Note}, coltitle=black, left=2mm, opacitybacktitle=0.6]
