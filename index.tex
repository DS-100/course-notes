...
\begin{tcolorbox}[enhanced jigsaw, toprule=.15mm, bottomrule=.15mm, colbacktitle=quarto-callout-note-color!10!white, arc=.35mm, colback=white, breakable, colframe=quarto-callout-note-color-frame, bottomtitle=1mm, opacityback=0, titlerule=0mm, leftrule=.75mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Note}, opacitybacktitle=0.6, left=2mm, toptitle=1mm, rightrule=.15mm, coltitle=black]
