...
\begin{tcolorbox}[enhanced jigsaw, coltitle=black, bottomtitle=1mm, breakable, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Note}, colframe=quarto-callout-note-color-frame, opacitybacktitle=0.6, left=2mm, colback=white, toptitle=1mm, arc=.35mm, titlerule=0mm, rightrule=.15mm, opacityback=0, toprule=.15mm, leftrule=.75mm, bottomrule=.15mm, colbacktitle=quarto-callout-note-color!10!white]
