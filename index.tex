...
\begin{tcolorbox}[enhanced jigsaw, left=2mm, colbacktitle=quarto-callout-note-color!10!white, toptitle=1mm, titlerule=0mm, colframe=quarto-callout-note-color-frame, coltitle=black, colback=white, leftrule=.75mm, breakable, bottomtitle=1mm, toprule=.15mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Note}, bottomrule=.15mm, opacitybacktitle=0.6, arc=.35mm, rightrule=.15mm, opacityback=0]
