...
\begin{tcolorbox}[enhanced jigsaw, bottomrule=.15mm, coltitle=black, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Note}, colbacktitle=quarto-callout-note-color!10!white, opacityback=0, bottomtitle=1mm, leftrule=.75mm, rightrule=.15mm, arc=.35mm, titlerule=0mm, breakable, toprule=.15mm, toptitle=1mm, opacitybacktitle=0.6, colback=white, colframe=quarto-callout-note-color-frame, left=2mm]
...
passed into the optional \texttt{index} argument.
...
collection of multiple Series, which all share the same index.
...
structures methods you should be fluent in. However, we want you to get
familiar with the real world programming practice of \ldots Googling!
Answers to your questions can be found in documentation, Stack Overflow,
etc.
