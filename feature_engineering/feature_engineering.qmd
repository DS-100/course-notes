...
<div align="middle">
  <table style="width:100%">
    <tr align="center">
      <td><img src="images/loss_surface.png" alt='3D loss surface' width='600'>
      </td>
    </tr>
  </table>
</div>
...
<div align="middle">
  <table style="width:100%">
    <tr align="center">
      <td><img src="images/stochastic.png" alt='Comparison of batch gradient descent and stochastic gradient descent. Batch gradient descent moves smoothly whereas stochastic gradient descent bounces back and forth.' width='600'>
      </td>
    </tr>
  </table>
</div>
...
<center><img src="images/complexity_grad_descent.png" alt='Complexity of gradient descent is O(nd)' width='600'></center>
...
<center><img src="images/gd.png" alt='Example of batch gradient descent being calculated.' width='300'></center>
...
<center><img src="images/sgd.png" alt='Example of stochastic gradient descent being calculated.' width='300'></center>
...
<center><img src="images/phi.png" alt='In this example, applying a feature function adds a column to the dataset.' width='700'></center>
...
<center><img src="images/ohe.png" alt='Illustration of one hot encoding.' width='600'></center>
...
<center><img src="images/ohemodel.png" alt='Design matrix showing raw features highlighted separately from one-hot encoded features.' width='600'></center>
...
<center><img src="images/bias.png" alt='Illustration of how the original data is transformed with one hot encoding and a bias column.' width='600'></center>
...
<center><img src="images/remove.png" alt='Illustration of removing one of the columns from one hot encoding or the bias column.' width='600'></center>
...
<center><img src="images/degree_comparison.png" alt='Three different plots with differening numbers of polynomial terms.' width='900'></center>
...
<center><img src="images/degree_comparison2.png" alt='Comparison of plots with different numbers of polynomial terms.' width='850'></center>
...
<center><img src="images/train_error.png" alt='Conceptual plotting of training error. As model complexity increases, training error decreases.' width='400'></center>
...
<center><img src="images/perfect_poly_fits.png" alt='Three different datasets consisting of five datapoints. Each dataset is perfectly fit by a degree-4 polynomial curve.' width='600'></center>
:::
...
<center><img src="images/complex.png" alt='On the left is the six datapoints with a perfectly fit curve. On the right, the rest of the population is shown and it is clear that the curve does not fit the population.' width='600'></center>
...
<center><img src="images/resamples.png" alt='Three different resamples from the above population.' width='800'></center>
...
<center><img src="images/bvt.png" alt='Illustration of underfitting and overfitting. ' width='400'></center>
...
<center><img src="images/complexity_normal_solution.png" alt='Illustration of the normal equation with matrices.' width='600'></center>
...
<center><img src="images/pytorchsgd.png" alt='Code for using pytorch to calculate stochastic gradient descent.' width='500'></center>
