...
### Stochastic (Minibatch) Gradient Descent (TO FINISH)

Let's look at the computational complexity for the solution to the normal equations.
<div align="middle">
...
Looking back at the complexity for gradient descent, suppose we run $T$ iterations then the final complexity is $O(Tnd)$. Typically $n$ is much larger than $T$ or $d$. How can we reduce the cost of this algorithm using a technique in Data 100?
