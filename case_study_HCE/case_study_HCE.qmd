...
Digging further shows that not only was the system unfair to people across the axis of income, but it was also unfair across the axis of race (see figure above). The likelihood that your home was under- or over-assessed was highly dependent on your race did not sit well with many homeowners.


### Spotlight: Appeals

What actually caused this to come about? The whole answer is a lot bigger than just models. At the end of the day, these are real systems that have a lot of moving parts. One of those moving parts was the **appeals system**. Homeowners are mailed the value their home is assessed for by CCAO, and the homeowner can choose to appeal to a board of elected officials to try and change the listed value of their home, and thus how much they are taxed. In theory, this sounds like a very fair system: there is a human who oversees the final pricing of houses rather than just an algorithm. However, it ended up exacerbating the problems.   
...
<center><img src = "images/vis_8.png"></img></center>
<br />
...
<center><img src = "images/vis_9.png"></img></center>
<br />
...
2. Create a robust pipeline that accurately assesses property values at scale and is fair
...
Each of the above questions leads to a slew of other questions. Considering just the first question, one answer could be that an assessment is an estimate of the value of a home. This begs the question: what is the value of a home? What determines it? How do we know? For this class, we take it to be the house's market value.
...
For example, attributes can have different likelihoods of appearing in the data. For example, housing data in the floodplains geographic region of Chicago were less represented than other regions.
