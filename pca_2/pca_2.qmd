...
2. To find the $k$ **principal components**:
    ...
    b. The first $k$ columns of $V$ contain the $k$ **principal components** of $X$. The $k$-th column of $V$ is also known as the $k$-th latent factor and corresponds to the $k$-th largest singular value of $X$. 
