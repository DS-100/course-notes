...
* If a model has **low complexity**, it will likely have *high bias* and *low complexity*. 

<div align="center">
  <img src = "images/model_simple.gif" alt = "Low Complexity" width = "600" height = "400">
</div>

* If a model has **high complexity**, it will likely have *low bias* and *high complexity*.
