...
<img src="images/distribution_summary.png" alt='Illustration of what plots are appropriate based on the variables being used.' width='700'>
...
<img src="images/linearize.png" alt='The original data is plotted on the left with a clear non-linear relationship. On the right, the data has been transformed via log and a line is drawn on top of the data.' width='800'>
...
<img src="images/horizontal.png" alt='The outliers with large x, y values are highlighted.' width='450'>
...
<img src="images/tukey_mosteller.png" alt='Tukey Mosteller Bulge Diagram' width='300'>
...
<center><img src="images/bulge.png" alt='Example of applying the Tukey Mosteller Diagram' width='800'></img></a></center>
...
<img src="images/rugplot_encoding.png" alt='A dataframe is shown with an arrow pointing to lines, one per row labeled Mark (represents a datum). From there, another arrow points to values like 10x, 15px, and NONE labeled Encoding (Maps datum to visual position). Finally, a last arrow points to a rug plot.' width='600'> 
...
<img src="images/mutli_dim_encodings.png" alt='Example plot using four dimensions of the data.' width='400'> 
...
<img src="images/wrong_scale_viz.png" alt='Two lines representing two very differnt things, cancer screenings and abortions are shown overlapping with each other.' width='350'> 
...
::: {.column width="30%"}
<img src="images/good_viz_scale_1.png" alt='Now you can see that the cancer screen line is way above the line for abortions.' width='345'>
:::
...
::: {.column width="30%"}
<img src="images/good_viz_scale_2.png" alt='Another way to visualize the percent change in the number of procedures, this time with a bar chart.' width='345'>
:::
...
::: {.column width="30%"}
<img src="images/unrevealed_viz.png" alt='Line plot showing COVID-19 cases from March 2020 to April 2021.' width='345'>
:::
...
::: {.column width="30%"}
<img src="images/revealed_viz.png" alt='The same data is shown, this time zoomed in on March 2020 to May 2020.' width='345'>
:::
...
::: {.column width="30%"}
**Jet Colormap**
<img src="images/jet_colormap.png" alt='Jet Colormap with vivid colors' width='250'>
:::
...
::: {.column width="30%"}
**Viridis Colormap**
<img src="images/viridis_colormap.png" alt='Viridis Colormap with less bright colors.' width='250'>
:::
...
::: {.column width="30%"}
<img src="images/jet_four_by_four.png" alt='Four different color palettes are used to show the same four sets of data.' width='300'>
:::
...
::: {.column width="30%"}
<img src="images/jet_3_images.png" alt='Comparison of black and white with Jet.' width='250'>
:::
...
<img src="images/jet_perceptually_uniform.png" alt='Jet colormap is percieved as a piecewise linear function.' width='300'>
:::
...
<img src="images/viridis_perceptually_uniform.png" alt='Viridis colormap is percieved as a straight line.' width='336'>
:::
...
<img src="images/markings_viz.png" alt='Examples of markings.' width='400'>
...
::: {.column width="30%"}
<img src="images/male_female_earnings_barplot.png" alt='Bar plot of earnings separated by gender.' width='360'>
:::
...
::: {.column width="30%"}
<img src="images/male_female_earnings_scatterplot.png" alt='Scatterplot of earnings separated by gender.' width='340'>
:::
...
<img src="images/small_multiples.png" alt='Plot example with the geographic representation of the United States repeated multiple times.' width='600'>
